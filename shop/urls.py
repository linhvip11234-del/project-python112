...
urlpatterns = [
    ...
    path("don-hang/<int:don_id>/hoa-don-pdf/", views.invoice_pdf, name="invoice_pdf"),
    ...
    path("admin-panel/don-hang/<int:don_id>/hoa-don-pdf/", views.admin_invoice_pdf, name="admin_invoice_pdf"),
